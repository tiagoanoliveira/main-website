        ...
        <section id="sobre" className="py-14 px-4">
          <div className="max-w-6xl mx-auto">
            <AnimatedSection>
              ...
              <h2 className="text-4xl font-bold mb-8 max-w-xl">
