  ...
  return (
    <main className="editorial-home">
      ...
      <section id="top" className="editorial-hero">
        ...
        <div className="editorial-hero__inner"><p className="editorial-label">Software Development · Portugal</p><h1>Hi, I'm Tiago and I build solutions users love and businesses value.</h1><div className="editorial-hero__footer"><p>Websites, booking softwares, home automation systems, etc.</p><a href="#sobre" className="editorial-scroll">Scroll down to meet me <span>↓</span></a></div></div>
      </section>
